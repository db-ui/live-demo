...
This is especially meant for the files in the directories `public/fonts`, `public/icons` and `public/images` and `public/favicon.ico` as well, which are retrieved from [DB UI Core](https://db-ui.github.io/core/) anyhow.
